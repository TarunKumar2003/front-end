...
const SubmissionActivity = ({ dataValue }: Props) => {
  ...
  const getBarGraphConfig = (
    _dataValue: any
  ): ChartConfiguration<"line", (number | [number, number])[], unknown> => {
    return {
      type: "line",
      data: {
        ...
        datasets: [
          {
            ...
            borderWidth: 1,
            backgroundColor: ["rgba(116, 224, 232,0.9)"],
            fill: true,
          },
        ],
      },
